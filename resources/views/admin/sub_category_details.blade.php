                ...
                <table class="table table-bordered mb-4">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <img src="https://res.cloudinary.com/dagdz3cnk/image/upload/w_100,q_100/v1581928924/{{ $data['sub_category']['image'] }}"  />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('categories.details', $data['sub_category']['category']['id']) }}">
