                                    ...
                                    <div class="row inv--head-section">
                                        ...
                                        <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                            <div class="company-info">
                                                <img src="https://res.cloudinary.com/dagdz3cnk/image/upload/w_100,q_100/v1581928924/<?=Auth::user()->custom['setting']['logo']?>" class="navbar-logo" alt="logo">
                                            </div>
                                        </div>
                                                ...
                                                <table class="table">
                                                    <thead class="">
                                                        <tr>
                                                            ...
                                                            <th class="text-right" scope="col">{{ __('messages.price_before_discount') }}</th>
                                                            <th class="text-right" scope="col">{{ __('messages.price_after_discount') }}</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{ $item->id }}</td>
                                                            <td>{{ App::isLocale('en') ? $item->title_en : $item->title_ar }}</td>
                                                            <td class="text-right">{{ $item->count }}</td>
                                                            <td class="text-right">{{ $item->offer == 1 ? $item->price_before_offer : $item->final_price }} {{ __('messages.dinar') }}</td>
                                                            <td class="text-right">{{ $item->final_price }} {{ __('messages.dinar') }}</td>
                                                            <td class="text-right">{{ (double)$item->final_price * (double)$item->count }} {{ __('messages.dinar') }}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
