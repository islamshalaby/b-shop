                ...
                <table id="without-print" class="table table-hover non-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        @foreach ($data['ads'] as $ad)
                            <tr>
                                <td><?=$i;?></td>
                                <td><img src="https://res.cloudinary.com/dagdz3cnk/image/upload/w_100,q_100/v1581928924/{{ $ad->image }}"  /></td>
                                <td class="text-center blue-color"><a href="/admin-panel/ads/details/{{ $ad->id }}" ><i class="far fa-eye"></i></a></td>
                                @if(Auth::user()->update_data) 
                                    <td class="text-center blue-color" ><a href="{{ route('ads.edit', $ad->id) }}" ><i class="far fa-edit"></i></a></td>
                                @endif
                                @if(Auth::user()->delete_data) 
