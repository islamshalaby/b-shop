                                ...
                                <div class="col-md-3" >
                                    <div >
                                        <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                            ...
                                            <span class="new-control-indicator"></span><span class="new-chk-content"><img src="https://res.cloudinary.com/dagdz3cnk/image/upload/w_100,q_100/v1581928924/${ad.image}" /></span>
                                        </label>
                                    </div>     
                                </div>
                            `)
        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <select id="type" name="type" class="form-control">
                    ...
                    <option {{ $data['home_section']['type'] == 1 ? 'selected' : '' }} value="1">{{ __('messages.ads') }}</option>
                    <option {{ $data['home_section']['type'] == 2 ? 'selected' : '' }} value="2">{{ __('messages.categories') }}</option>
                    <option {{ $data['home_section']['type'] == 3 ? 'selected' : '' }} value="3">{{ __('messages.brands') }}</option>
                    <option {{ $data['home_section']['type'] == 4 ? 'selected' : '' }} value="4">{{ __('messages.offers') }}</option>
                    <option {{ $data['home_section']['type'] == 5 ? 'selected' : '' }} value="5">{{ __('messages.ad') }}</option>
                </select>
            </div>
